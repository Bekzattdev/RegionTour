"use client";
import scss from "./NarynMain.module.scss";
...
import narynImg from "../assets/img/naryntrue.png";
...
const NarynMain = () => {
  ...
  const main = {
    title: "Naryn",
    img: "https://s3-alpha-sig.figma.com/img/15d1/6627/6e90713d5f456cd0e5a160d232bb3289?Expires=1729468800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=gbL2BM47eOPGn1jKnCLtNzJI03ppkl5MBaDiC0Z0izCRr5Zy0VJmce~-cqXI2I5sZjXvmFE4Ho5TwMSNEu4zbSh6MSuxcnHWG4TEJXsOFdtkInuejaIwdGDLKknUoSrbSdCtztUW4n3okboaqRiXNhQVXUNIqPnv8qCl73M4eKNVkCsLfTopc0iup8IsHdCKWm8c~A25MhReGpKC2b6OHmXe~-QCFsCevwsQBUgEJNV3ycnYuFI6fbFfRv9VbFnsl~Gy4LRtgDf3Ei1x3w9orU6sNg5oZJl4geW0gDkcdUmtINnZT~I6bdph97XsDlnin4ffcN-x1FeyJAyV4Dq-Lg__",
    description:
